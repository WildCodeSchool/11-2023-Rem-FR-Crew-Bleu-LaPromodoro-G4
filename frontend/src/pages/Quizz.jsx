...
function Quizz() {
  ...
  useEffect(() => {
    const allQuestionsAnswered = answerBullets.every((bullet) => bullet !== "");
  ...
  const endTitle = "Niveau 3: Jeu de définitions fini !";
  ...
  return (
    <div>
      ...
      {quizFinished ? (
        <Results score={count} level={endTitle} />
      ) : (
        <div className="theBigQuizContainer">
